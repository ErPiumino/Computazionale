...
axs[0,0].scatter(x1black, v1black, color='black', marker='.', s=0.5)
axs[0,0].scatter(x1yellow, v1yellow, color='yellow', marker='.', s=0.5)
axs[0,0].set_title('$F0=1.07, t^*=100.00$', fontsize=25)
axs[0,1].scatter(x2black, v2black, color='black', marker='.', s=0.5)
axs[0,1].scatter(x2yellow, v2yellow, color='yellow', marker='.', s=0.5)
axs[0,1].set_title('$F0=1.15, t^*=100.00$', fontsize=25)
axs[1,0].scatter(x3black, v3black, color='black', marker='.', s=0.5)
axs[1,0].scatter(x3yellow, v3yellow, color='yellow', marker='.', s=0.5)
axs[1,0].set_title('$F0=1.47, t^*=93.00$', fontsize=25)
axs[1,1].scatter(x4black, v4black, color='black', marker='.', s=0.5)
axs[1,1].scatter(x4yellow, v4yellow, color='yellow', marker='.', s=0.5)
