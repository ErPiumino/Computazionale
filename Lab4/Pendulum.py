...
fig.suptitle('Pendolo forzato con RK4 per vari $f0 t$')
...
axs[0].plot(x3, y3, color='green', label='$F0 = 1.150$', alpha=0.5)
...
axs[1].plot(e3, y3, color='green', label='$F0 = 1.150$', alpha=0.5)
