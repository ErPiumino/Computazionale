...
x2, y2, e2 = np.loadtxt('PendoloCaoticoF01.150.dat', usecols=(2, 0, 3), unpack=True)
x3, y3, e3 = np.loadtxt('PendoloCaoticoF01.470.dat', usecols=(2, 0, 3), unpack=True)
x4, y4, e4 = np.loadtxt('PendoloCaoticoF01.500.dat', usecols=(2, 0, 3), unpack=True)
