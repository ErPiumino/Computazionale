...
axs[1].plot(e1, y1, color='darkslategrey', label='$F0 = 0.900$', alpha=0.5, linewidth=0.5)
axs[1].plot(e2, y2, color='blue', label='$F0 = 1.070$', alpha=0.5, linewidth=0.5)
axs[1].plot(e3, y3, color='green', label='$F0 = 1.150$', alpha=0.5, linewidth=0.5)
axs[1].plot(e4, y4, color='skyblue', label='$F0 = 1.470$', alpha=0.5, linewidth=0.5)
axs[1].plot(e5, y5, color='red', label='$F0 = 1.500$', alpha=0.5, linewidth=0.5)
