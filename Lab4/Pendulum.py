...
# Data per x(t) e e(t)
x1, y1, v1 = np.loadtxt('PendoloCaoticoF00.900.dat', usecols=(2, 0, 1), unpack=True)
x2, y2, v2 = np.loadtxt('PendoloCaoticoF01.070.dat', usecols=(2, 0, 1), unpack=True)
x3, y3, v3 = np.loadtxt('PendoloCaoticoF01.150.dat', usecols=(2, 0, 1), unpack=True)
x4, y4, v4 = np.loadtxt('PendoloCaoticoF01.470.dat', usecols=(2, 0, 1), unpack=True)
x5, y5, v5 = np.loadtxt('PendoloCaoticoF01.500.dat', usecols=(2, 0, 1), unpack=True)
