...
xp1, vp1 = np.loadtxt('PuntiPoincarreF00.900.dat', usecols=(0, 1), unpack=True)
xp2, vp2 = np.loadtxt('PuntiPoincarreF01.070.dat', usecols=(0, 1), unpack=True)
axs[0,0].scatter(x1, v1, color='blue', label='$F0 = 0.900$', marker='.', s=0.001)
axs[0,0].scatter(xp1, vp1, color='red', label='$F0 = 0.900$', marker='.', s=100)
axs[0,0].legend(loc='upper left', fontsize=8)
axs[0,1].scatter(x2, v2, color='blue', label='$F0 = 1.07$', s=0.001)
axs[0,1].scatter(xp2, vp2, color='red', label='$F0 = 0.900$', marker='.', s=100)
axs[0,1].legend(loc='upper left', fontsize=8)
axs[1,0].scatter(x3, v3, color='blue', label='$F0 = 1.15$', s=0.001)
axs[1,0].legend(loc='upper left', fontsize=8)
axs[1,1].scatter(x4, v4, color='blue', label='$F0 = 1.47$', s=0.001)
axs[1,1].legend(loc='upper left', fontsize=8)
axs[2,0].scatter(x5, v5, color='blue', label='$F0 = 1.50$', s=0.001)
